...
function getJsonData() {
    ...
    // jogos
    data = '[ { "titulo": "Futebol de Botões", "plataforma": "Windows, Linux e Web", "tecnologias": "C++ e SDL2", "descricao": "Jogo simples no estilo de futebol de botões escrito do zero em C++ utilizando a biblioteca gráfica SDL2. Possúi um sistema físico e gráfico simples. Foi desenvolvido em 2020 como projeto para a disciplina de Programação Orientada a Objetos I.", "midia": "recources/media/futebol_de_botoes_game.png", "link": "futebol_de_botoes/play.html" }, { "titulo": "Titulo do aplicativo", "plataforma": "Android ou IOS", "tecnologias": "listagem das tecnologias utilizadas", "descricao": "bla bla bla bla bla", "midia": "link para a midia", "link": "" }, { "titulo": "Titulo do jogo", "plataforma": "Android ou IOS", "tecnologias": "listagem das tecnologias utilizadas", "descricao": "bla bla bla bla bla", "midia": "link para a midia", "link": "" }, { "titulo": "Titulo do sistema", "plataforma": "Android ou IOS", "tecnologias": "listagem das tecnologias utilizadas", "descricao": "bla bla bla bla bla", "midia": "link para a midia", "link": "" } ]'
    aux = JSON.parse(data);
